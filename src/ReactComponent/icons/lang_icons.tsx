...
/*
  ...
  ------------------
*/
export function SoplangIcon({ dimension = 32 }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      xmlSpace="preserve"
    ...
    >
      ...
      <path
        d="m126.33 45.76-4.64-24.5L77.3 42.43 65.29 5.47 50.27 51.7H1.67l39.32 28.57-2.31 7.13-22.3 10.63 4.65 24.5 7.38-3.52 22.92-10.93 10.04-4.79 6.83-3.26 24.09-11.49 4.09-1.95 9.19-4.39-6.93-8.5L90 63.09l23.88-11.39 12.45-5.94zM95.71 75.83l4.15 5.09-8.71 4.15-61.22 29.2-6.24 2.98-3.26-17.17 16.7-7.96 51.74-24.68 6.84 8.39zm-41.88.51L42.85 62.86 78.43 45.9l40.6-19.37 3.26 17.16-16.79 8.01-51.67 24.64z"
        style={{
          fill: "#4b8bc9",
        }}
      />
      <path
        d="m99.86 80.93-8.7 4.15-61.22 29.2-6.24 2.98-3.26-17.17 16.7-7.96 51.74-24.68 6.83 8.38zM122.28 43.7l-16.8 8-51.64 24.64-10.99-13.48L78.43 45.9l40.59-19.37z"
        className="st1"
      />
    </svg>
  );
