/*
  ...
  ------------------
*/
export function LinuxIcon({ dimension = 32 }) {
  return (
    <svg
...
/*
  ...
  ------------------
*/
export function UbuntuIcon({ dimension = 32 }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={dimension}
...
/*
  ...
  ------------------
*/
export function WindowsIcon({ dimension = 28 }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={dimension}
...
/*
  ...
  ------------------
*/
export function MacOSIcon({ dimension = 32, color = "currentColor" }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={dimension}
