...
<Intro>
 Luuqadan Javascript waxa la sameeyey sannadku marku ahaa , waxaana lo sameeyey si logu adeegsado dhisitaanka websites, sababtuna waxay ahayd in websites laga dhigo  qaar nool iyado javascript lo adeegsanayo si ula fal gasho  HTML iyo  CSS. Luuqadan waxyaabo badan ayaad ku dhisi karta oo ay ka mid yihiin: web apps, mobile apps, desktop apps, games(browser-based games) iyo waxyaabo kale oo badan.
 </Intro>
